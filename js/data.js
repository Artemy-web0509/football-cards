...
const REAL_PLAYERS = [
  ...
  { name: 'Эван Фергюсон', flag: '🇮🇪', pos: 'FW', rating: 74 }, { name: 'Байандер', flag: '🇩🇰', pos: 'DF', rating: 73 },
  { name: 'Доньи', flag: '🇨🇮', pos: 'DF', rating: 72 }, { name: 'Кайнер', flag: '🇦🇹', pos: 'MF', rating: 73 },
  { name: 'Осамен', flag: '🇳🇬', pos: 'FW', rating: 77 }, { name: 'Ихэаначо', flag: '🇳🇬', pos: 'FW', rating: 76 },
  { name: 'Кудус', flag: '🇬🇭', pos: 'MF', rating: 80 }, { name: 'Атар', flag: '🇸🇳', pos: 'MF', rating: 78 },
  { name: 'Манде', flag: '🇸🇳', pos: 'GK', rating: 72 }, { name: 'Диаките', flag: '🇸🇳', pos: 'DF', rating: 71 },
  { name: 'Медведев', flag: '🇷🇺', pos: 'GK', rating: 70 }, { name: 'Глебов', flag: '🇷🇺', pos: 'MF', rating: 70 },
  { name: 'Кисляк', flag: '🇷🇺', pos: 'DF', rating: 69 }, { name: 'Русаков', flag: '🇷🇺', pos: 'FW', rating: 69 },
  { name: 'Осипенко', flag: '🇷🇺', pos: 'DF', rating: 68 }, { name: 'Шапи', flag: '🇷🇺', pos: 'FW', rating: 68 },
  { name: 'Белов', flag: '🇷🇺', pos: 'MF', rating: 67 }, { name: 'Козлов', flag: '🇷🇺', pos: 'DF', rating: 66 },
  { name: 'Тихонов', flag: '🇷🇺', pos: 'FW', rating: 66 }, { name: 'Соколов', flag: '🇷🇺', pos: 'MF', rating: 65 },
  ...
  { name: 'Андерсон', flag: '🇳🇴', pos: 'GK', rating: 79 }, { name: 'Гуйта', flag: '🇳🇱', pos: 'GK', rating: 83 },
  { name: 'Абрамович', flag: '🇷🇸', pos: 'GK', rating: 81 }, { name: 'Рамдаан', flag: '🇳🇱', pos: 'GK', rating: 78 },
  { name: 'Кастилс', flag: '🇧🇪', pos: 'GK', rating: 78 }, { name: 'Мерит', flag: '🇩🇰', pos: 'DF', rating: 78 },
  { name: 'Кристенсен', flag: '🇩🇰', pos: 'DF', rating: 81 }, { name: 'Нолан', flag: '🇮🇪', pos: 'DF', rating: 75 },
  { name: 'Артойл', flag: '🇪🇸', pos: 'DF', rating: 77 }, { name: 'Мандфорд', flag: '🏴', pos: 'DF', rating: 76 },
  { name: 'Битрана', flag: '🇧🇷', pos: 'DF', rating: 76 }, { name: 'Гассан', flag: '🇹🇳', pos: 'DF', rating: 74 },
  { name: 'Мибанда', flag: '🇿🇦', pos: 'DF', rating: 71 }, { name: 'Качтон', flag: '🇺🇸', pos: 'DF', rating: 72 },
  // ⭐ Полузащитники и нападение (больше звёзд)
  { name: 'Бруну', flag: '🇧🇷', pos: 'MF', rating: 76 }, { name: 'Гарет', flag: '🏴', pos: 'MF', rating: 75 },
  { name: 'Аморим', flag: '🇵🇹', pos: 'MF', rating: 74 }, { name: 'Кристиан', flag: '🇸🇪', pos: 'MF', rating: 76 },
  { name: 'Маршалл', flag: '🏴', pos: 'MF', rating: 73 }, { name: 'Смит', flag: '🏴', pos: 'MF', rating: 72 },
  { name: 'Джонсон', flag: '🏴', pos: 'MF', rating: 71 }, { name: 'Ливайн', flag: '🇮🇪', pos: 'MF', rating: 70 },
  { name: 'Баттон', flag: '🏴', pos: 'MF', rating: 69 }, { name: 'Хардинг', flag: '🏴', pos: 'FW', rating: 70 },
  { name: 'Грив', flag: '🏴', pos: 'FW', rating: 71 }, { name: 'Мерфи', flag: '🇮🇪', pos: 'FW', rating: 72 },
  { name: 'Парсонс', flag: '🏴', pos: 'FW', rating: 71 }, { name: 'Тэйлор', flag: '🏴', pos: 'FW', rating: 70 },
  { name: 'Морейра', flag: '🇵🇹', pos: 'FW', rating: 78 }, { name: 'Нил', flag: '🏴', pos: 'FW', rating: 68 },
  ...
  { name: 'Авра', flag: '🇮🇪', pos: 'FW', rating: 78 }, { name: 'Уэсли', flag: '🇮🇪', pos: 'DF', rating: 77 },
  ...
  { name: 'Фергюсон', flag: '🇮🇪', pos: 'FW', rating: 76 }, { name: 'Гримшоу', flag: '🏴', pos: 'DF', rating: 73 },
  { name: 'Харрис', flag: '🏴', pos: 'FW', rating: 74 }, { name: 'Райт', flag: '🏴', pos: 'MF', rating: 72 },
  { name: 'Льюис', flag: '🏴', pos: 'FW', rating: 73 }, { name: 'Коул', flag: '🏴', pos: 'FW', rating: 74 },
  { name: 'Джеймс', flag: '🏴', pos: 'MF', rating: 72 }, { name: 'Бейл', flag: '🏴', pos: 'FW', rating: 86 },
  { name: 'Джек Грилиш', flag: '🏴', pos: 'MF', rating: 85 }, { name: 'Маунт', flag: '🏴', pos: 'MF', rating: 84 },
