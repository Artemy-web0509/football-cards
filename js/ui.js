...
function showScreen(name) {
  ...
  const scroll = (name === 'spinner' || name === 'field' || name === 'backpack' || name === 'arena' || name === 'stadium' || name === 'market' || name === 'marketplace' || name === 'index' || name === 'match' || name === 'admin' || name === 'luck' || name === 'fieldupg' || name === 'quests' || name === 'donat');
  ...
  else if (name === 'stadium') renderStadium();
